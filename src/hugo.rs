...
pub fn dump_all() -> io::Result<()> {
    ...
    walk_markdown_files(&path, &path)
}

// TODO pass in callback
fn walk_markdown_files(root: &Path, dir: &Path) -> io::Result<()> {
